<?php
/**
* API Endpoint - סטטוס פתרון למידה (lookup_solution_status)
...
try {
    ...
    // שליפת סטטוסי הפתרון מהטבלה lookup_solution_status
    $stmt = $conn->query("SELECT * FROM lookup_solution_status ORDER BY id ASC");
