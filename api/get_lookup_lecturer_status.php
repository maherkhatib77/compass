<?php
/**
* API Endpoint - סטטוס מרצה (lookup_lecturer_status)
...
try {
    ...
    // שליפת סטטוסי המרצה מהטבלה lookup_lecturer_status
    $stmt = $conn->query("SELECT * FROM lookup_lecturer_status ORDER BY id ASC");
