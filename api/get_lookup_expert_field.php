<?php
/**
* API Endpoint - תחומי מומחיות (lookup_expert_field)
...
try {
    ...
    // שליפת תחומי המומחיות מהטבלה lookup_expert_field
    $stmt = $conn->query("SELECT * FROM lookup_expert_field ORDER BY id ASC");
