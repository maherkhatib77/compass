<?php
/**
* API Endpoint - מרצה מוסב (lookup_certified_lecturer)
...
try {
    ...
    // שליפת המרצים המאושרים מהטבלה lookup_certified_lecturer
    $stmt = $conn->query("SELECT * FROM lookup_certified_lecturer ORDER BY id ASC");
